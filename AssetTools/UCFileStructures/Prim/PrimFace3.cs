...
public partial class PrimFace3 : PrimFace, IPrimFace
{
	...
	*/
	...
	public ushort[] Points { get; set; } // [3]

	[Deserializer.FixedArray(Dimensions = [3, 2])]
	public byte[][] CompressedUV { get; set; } // [3][2]

	[Deserializer.FixedArray(Dimensions = [3])]
	public short[] Bright { get; set; } // [3] make into byte

	public short ThingIndex { get; set; }
	public ushort Col2 { get; set; }
	public ushort FaceFlags { get; set; }
	public byte Type { get; set; }      // move after bright
	public sbyte ID { get; set; }        // delete 
